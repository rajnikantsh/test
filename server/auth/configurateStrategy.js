...
exports.setConfiguratins = function(data){
    if (data && data.passportStrategies) {
        ...
        //Idp1Strategy
        if (data.passportStrategies.idp1) {
            logger.log('info', 'Idp1 Strategy details received');
            logger.sendMQMessage('info: Idp1 Strategy details received');
            Idp1Strategy.setCredentials(data.passportStrategies.idp1);
        }
