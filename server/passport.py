    ...
    def prepareForStep(self, configurationAttributes, requestParameters, step):
        if (step == 1):
            ...
            try:
                ...
                resultResponse = httpService.executeGet(httpclient, 'https://rk.local/passport/token', headersMap)
	        	...
	        	print "/passport/auth/"+stateObj["provider"]+"/"+tokenObj["token_"]
	        	facesService.redirectToExternalURL("https://rk.local/passport/auth/"+stateObj["provider"]+"/"+tokenObj["token_"],)
            except Exception, err:
                print ("Passport: Error " + str(err))
